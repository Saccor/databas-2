...
async function addNewSupplier() {
  try {
    const supplierName = prompt('Enter new supplier name (required): ');
    const supplierDescription = prompt('Enter new supplier description: ');
...
async function removeSupplier() {
  try {
    const supplierName = prompt('Enter the name of the supplier to remove: ');
